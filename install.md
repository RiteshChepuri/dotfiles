...
```
yay -S starship waybar rofi fish zoxode lsd fd ripgrep bat lf fzf lazygit tmux luarocks ruby nodejs npm git-delta deno blueman xclip julia discord dunst rust composer php python-pip python-pynvim mercurial swaylock github-cli brillo pamixer ttf-hack-nerd google-chrome tofi wezterm brave-bin btop nemo pavucontrol hyprlock hyprpaper
